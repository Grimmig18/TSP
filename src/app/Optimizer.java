...
public class Optimizer {
        ...
        for (int i = 1; i < nodes.length; i++) {
            for (int j = 1; j < nodes.length; j++) {
                ...
                //    if(!(i == j)) {
                    ...
                    if(nodeA1.compareTo(nodeB1) != 0 && nodeA1.compareTo(nodeB2) != 0 && nodeA2.compareTo(nodeB1) != 0 && nodeA2.compareTo(nodeB2) != 0) {
    ...
    private static Graph removeCrossover(Graph graph, Node nodeFrom, Node nodeTo) {
        ...
        while(nodeFrom != null && nodeTo != null && nodeFrom.getID() != nodeTo.getID() && graph.findNode(nodeFrom) < graph.findNode(nodeTo)) {
